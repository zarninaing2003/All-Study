...
// // const arrFun = ()=> "I am arrow Function";
...
const stringArray = ["Blue", "Humpback", "Beluga", "Orange", "Apple"];
...
//  const result  =  mixedNumericArray.sort((a,b) => {
//     return a-b ;
// })
// console.log(result);
...
// const result = products.sort((a, b) => {
//   return a.title[0].toLocaleLowerCase() - b.title[0].toLocaleLowerCase();
// });
...
// console.log(mixedNumericArray.slice(1,4));
// console.log(mixedNumericArray);

// console.log(mixedNumericArray);
// console.log(mixedNumericArray.splice(1,4,"aaa","bb"));
// console.log(mixedNumericArray);

// console.log(stringArray.concat(mixedNumericArray).concat(numberArray));

// console.log([...mixedNumericArray,"xxx",...stringArray]);
...
// console.log(points);
//  const mp =  points.map(point => point +10);
//  console.log(mp);
...
//   // return product.id === 5 || product.id  ===6 || product.id  === 7

//   // return [5,6,3,2,9].includes(product.id);
//   return product.title.toLowerCase().search("men");
// })
...
//   .map((el) => {
//     el.price += 10;
//     return el.title.substr(0, 10) + "....." + " -" + el.price;
//   })
//   .join("\n");
