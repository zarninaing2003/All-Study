...
function choiceEvenOdd(numberArray){
    const  evenArray = [];
...
// console.log(choiceEvenOdd(points));
...
// console.log(slice(points,10));

// startIndex thi ya mal
// endIndex ?
function doubleSlice(array,startIndex,count){
    const resultArray = [];
    let resultArrayIndex  = 0;
...
// console.log(points);
// console.log(doubleSlice(points,0,5));
// console.log(doubleSlice(points,3,4));
...
// console.log(isContain(points, 5));
// console.log(isContain(points, 15));
// console.log(isContain(points, 52));
...
const newProducts = arrayCopy(products)
...
// let totalMark= 0;
// let overResult =  "Passed";
// for( sub of student1Mark){
//     // console.log(sub,sub.mark);
//  totalMark += sub.mark;
// //  sub.result  = sub.mark >= 40 ? "Passed" : "Failed"
// if( sub.mark >= 40){
//     sub.result =  "Passed"
// }else{
//     sub.result =  "Failed"
